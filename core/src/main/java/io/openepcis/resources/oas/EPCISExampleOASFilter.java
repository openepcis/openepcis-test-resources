...
public class EPCISExampleOASFilter implements OASFilter {
    ...
    Map<String, Example> generateExamples() throws IOException {
        ...
        final String epcisXmlObjectEvent =
                new String(
                        Objects.requireNonNull(
                                        getClass()
                                                .getClassLoader()
                                                .getResourceAsStream("2.0/EPCIS/XML/Capture/Events/ObjectEvent.xml"))
                                .readAllBytes());
        ...
        examples.put(EXAMPLE_2_0_0_JSON_DOCUMENT, OASFactory.createExample().value(objectMapper.readValue(epcisJsonEvents, ObjectNode.class)));
        examples.put(EXAMPLE_2_0_0_JSON_EVENT_LIST, OASFactory.createExample().value(epcisJsonEventsList));

        // Adding EPCIS XML 2.0 Individual events
