...
public class EPCISExampleOASFilter implements OASFilter {
  ...
  Map<String, Example> generateExamples() throws IOException {
    ...
    examples.put(
        EXAMPLE_2_0_0_JSON_EVENT_LIST, OASFactory.createExample().value(epcisJsonEventsList));
    examples.put(
        EXAMPLE_2_0_0_XML_OBJECT_EVENT, OASFactory.createExample().value(epcisXmlObjectEvent));
    return examples;
  }
}
